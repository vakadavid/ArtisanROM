...
# Device configuration file for Galaxy S20 Ultra (Exynos) (z3s)
TARGET_NAME="Galaxy S20 Ultra (Exynos)"
TARGET_CODENAME="z3s"
TARGET_ASSERT_MODEL=("SM-G988B")
TARGET_PLATFORM="exynos990"
TARGET_FIRMWARE="SM-G988B/AUT/351828112077457"
...
TARGET_DVFSAPP_CONFIG_SSRM_POLICY_FILENAME="siop_z3s_exynos990"
